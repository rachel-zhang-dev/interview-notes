# Interview Notes · 面试学习笔记

> 个人面试题库与技术学习笔记，持续整理中。
> 在线访问：[https://rachel-zhang-dev.github.io/interview-notes/](https://rachel-zhang-dev.github.io/interview-notes/)
...
推荐使用 GitHub Pages 部署后的链接，针对移动端做了响应式优化：

- 可折叠题目卡片
- 关键词搜索
- 分类筛选
- 进度跟踪（已掌握 / 待复习，存储在浏览器本地）
...
仅供个人学习参考，禁止用于商业用途。题目答案为个人理解整理，可能存在不严谨之处，欢迎指正。
